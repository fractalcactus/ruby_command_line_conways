...
class TestConways < Test::Unit::TestCase
 ...
 def test_click
  toad_clicked_once = [
    ...
    [DEAD_CELL_GRAPHIC,DEAD_CELL_GRAPHIC,DEAD_CELL_GRAPHIC,ALIVE_CELL_GRAPHIC,DEAD_CELL_GRAPHIC,DEAD_CELL_GRAPHIC],
    [DEAD_CELL_GRAPHIC,ALIVE_CELL_GRAPHIC,DEAD_CELL_GRAPHIC,DEAD_CELL_GRAPHIC,ALIVE_CELL_GRAPHIC,DEAD_CELL_GRAPHIC],
    [DEAD_CELL_GRAPHIC,ALIVE_CELL_GRAPHIC,DEAD_CELL_GRAPHIC,DEAD_CELL_GRAPHIC,ALIVE_CELL_GRAPHIC,DEAD_CELL_GRAPHIC],
    [DEAD_CELL_GRAPHIC,DEAD_CELL_GRAPHIC,ALIVE_CELL_GRAPHIC,DEAD_CELL_GRAPHIC,DEAD_CELL_GRAPHIC,DEAD_CELL_GRAPHIC],
    [DEAD_CELL_GRAPHIC,DEAD_CELL_GRAPHIC,DEAD_CELL_GRAPHIC,DEAD_CELL_GRAPHIC,DEAD_CELL_GRAPHIC,DEAD_CELL_GRAPHIC],
  ]
